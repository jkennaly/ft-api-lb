...
const getItem = async (value, TableName, keyField) => {
    const params = {
        TableName,
        Key: { [keyField]: value },
    };
...
const upsertItemOld = async (Item, TableName, keyField) => {
    const params = {
        TableName,
 ...
 */
const upsertItem = async (item, tableName, keyField) => {
...
module.exports = { createItem, upsertItem, getItem }